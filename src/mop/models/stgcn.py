...
from ..utils.stgcnutils.tgcn import ConvTemporalGraphical
from ..utils.stgcnutils.graph import Graph
...
class STGCN(nn.Module):
    ...
    def __init__(self, in_channels, num_class, graph_args,
        ...
        A = torch.tensor(self.graph.A, dtype=torch.float32, requires_grad=False).to(self.device)
    ...
    def forward(self, input):
        ...
        x = input.permute(0, 3, 1, 2).unsqueeze(4).contiguous()
